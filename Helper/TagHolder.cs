...
public class AnimationTags
{
    ...
    public const string ZOOM_IN_ANIM = "In";
    public const string ZOOM_OUT_ANIM = "Out";

    public const string CANT_AIM = "CantAim";

    public const string SHOOT_TRIGGER = "Shoot";
    public const string AIM_PARAMETER = "Aim";
    public const string SELF_AIM = "SelfAim";
    public const string SELF_AIM_OUT = "SelfAimOut";
