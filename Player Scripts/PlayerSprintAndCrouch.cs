...
public class PlayerSprintAndCrouch : MonoBehaviour {
    ...
    private float sprint_Step_Distence = 0.25f;
    private float crouch_Step_Distence = 0.5f;
    ...
    void Sprint()
    {
        ...
        if(sprint_Value > 0f)
        {
            ...
            if (Input.GetKeyDown(KeyCode.LeftShift) && !is_Crouching)
            {
                ...
                player_Footsteps.step_Distence = sprint_Step_Distence;
    ...
    void Crouch()
    {
        ...
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            else
            {
                ...
                player_Footsteps.step_Distence = crouch_Step_Distence;
